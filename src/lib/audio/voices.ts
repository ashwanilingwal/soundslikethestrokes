...
export interface VoiceParams {
  ...
  warbleCents: number;
  /**
   * 0 = the wobble is always on (tape wow). Above 0 = a singer's vibrato:
   * silent through speech and note attacks, blooming only once a note has
   * been held this long.
   */
  warbleOnsetMs: number;
  roomMix: number;
  /** 0 = a tight booth, 1 = a long plate; in between is both at once. */
  roomSize: number;
  /** Lowpass on the reverb return only. Dark and woolly low, airy high. */
  roomToneHz: number;
...
export const VOICES: Voice[] = [
  /* ------------------------------------------------------------ The Strokes
   * One voice per record with a sleeve on the shelf, in release order. The
   * numbers are what those records actually do to a vocal, not a spread of
   * settings chosen to sound different from each other: the early ones are
   * an amp and a compressor with no digital anything, the demo is a soft
   * cassette, Comedown Machine is the processed one, and The New Abnormal
   * is the only hi-fi record of the five. */
  {
    id: "julian-1",
    artist: "julian",
    category: "strokes",
    ...
    era: "Is This It · 2001",
    eraShort: "Garage '01",
    varies: "Sung through a practice amp: crushed by compression, all midrange, bone dry. Analog dirt — no digital crunch anywhere.",
    retuneGlideMs: 30,
    dryWet: 1,
    drive: 8,
    bits: 16,
  ...
  },
  {
    ...
    eraShort: "Amp '03",
    varies: "The same amp with the window open: a wider band, a little air on top and a touch of room. Cleaner than Is This It without being clean.",
    retuneGlideMs: 30,
    dryWet: 1,
    drive: 7,
    bits: 16,
  ...
  },
  {
    ...
    eraShort: "Demo '06",
    varies: "A home demo: soft, close and warm under a veil of tape, with a slow wow and a small room. The most sung of the five — no bite at all.",
    retuneGlideMs: 45,
    dryWet: 1,
    drive: 5,
    bits: 16,
  ...
  },
  {
    ...
    eraShort: "Machine '13",
    varies: "Processed on purpose: digital crunch, a fast flutter, a near-instant snap and a synthetic sheen of echo — the robotic later-Strokes vocal.",
    retuneGlideMs: 6,
    dryWet: 1,
    drive: 6.5,
    bits: 11,
  ...
  },
  {
    ...
    eraShort: "Hi-fi '20",
    varies: "Lifted three semitones towards the falsetto register, hi-fi and warm, with a light vibrato on held notes and a big bright plate behind it. The cleanest Strokes voice.",
    retuneGlideMs: 22,
    dryWet: 1,
    drive: 3,
    bits: 16,
    ...
    echoFeedback: 0.3,
    echoMix: 0.22,
    // Three, not five. Shifting moves the formants with the pitch, and past
    // about four semitones a grain shifter stops reading as "higher" and
    // starts reading as a smaller person. Three lifts the register and thins
  ...
  },
  {
    ...
    era: "hard-tuned",
    eraShort: "Julian",
    varies: "The Try Anything Once haze with the glide killed and the wet locked at 100% — every syllable stair-steps onto the grid.",
    autotuned: true,
    retuneGlideMs: 0,
    dryWet: 1,
    drive: 9,
    ...
    warbleOnsetMs: 0,
    roomMix: 0.22,
    // The auto voices keep the space they were tuned in: the old single room
    // was this long and this dark, and they were signed off sounding right.
    roomSize: 1,
    roomToneHz: 1900,
    echoMs: 190,
    echoFeedback: 0.28,
  ...
  /* -------------------------------------------------------- Arctic Monkeys */
  {
    ...
    varies: "Bright, dry and fast: wide-open top, hard consonants, barely any room. The least processed voice on the shelf.",
    retuneGlideMs: 35,
    dryWet: 1,
    drive: 3,
    bits: 16,
  ...
  },
  {
    ...
    era: "AM · 2013",
    eraShort: "Desert '13",
    varies: "Smooth and close, with the record's slapback — one quick repeat behind every line — and a warm, rounded top.",
    retuneGlideMs: 30,
    dryWet: 1,
    drive: 4.5,
    bits: 16,
  ...
  },
  {
    ...
    eraShort: "Lounge '18",
    varies: "Down two semitones into the crooner register, close in front of a long bright plate with a tape echo behind it. The wettest voice here, and still clear.",
    retuneGlideMs: 40,
    dryWet: 1,
    drive: 2.5,
    bits: 16,
  ...
  },
  {
    ...
    era: "The Car · 2022",
    eraShort: "Strings '22",
    varies: "The same crooner, drier and closer, with a singer's vibrato that only blooms on held notes — speak and it stays steady, hold a note and it sings.",
    retuneGlideMs: 40,
    dryWet: 1,
    drive: 2.5,
    bits: 16,
  ...
  /* ----------------------------------------------------------- Post Malone
   * All hard-tuned, because all the records are. What moves between them is
   * everything else: the mixtape is warm and hazy, beerbongs is dark and
   * tight, Hollywood's Bleeding is the bright stadium one, Twelve Carat is
   * rougher and drier again. */
  {
    id: "posty-auto",
    artist: "posty",
    category: "auto",
  ...
  },
  {
    ...
    category: "pm",
    label: "Posty I",
    era: "August 26th · 2016",
    eraShort: "Bedroom '16",
    varies: "The mixtape: warm and hazy under a hard tune, a rounded top and a soft room — the melodic-drawl end of autotune.",
    autotuned: true,
    retuneGlideMs: 0,
    dryWet: 1,
    drive: 4.5,
  ...
  },
  {
    ...
    category: "pm",
    label: "Posty II",
    era: "beerbongs & bentleys · 2018",
    eraShort: "Trap '18",
    varies: "Darker and tighter than the stadium record: a clean hard tune, a medium plate and a doubled-hook echo. The rockstar-era vocal.",
    autotuned: true,
    retuneGlideMs: 0,
    dryWet: 1,
    drive: 3,
  ...
  },
  {
    ...
    eraShort: "Stadium '19",
    varies: "The stadium version: the cleanest path here, the brightest top and the biggest, brightest hall. Tuning is the only effect doing work.",
    autotuned: true,
    retuneGlideMs: 0,
    dryWet: 1,
    drive: 2,
  ...
  },
  {
    ...
    eraShort: "Rough '22",
    varies: "Rougher and drier than the two before it: real saturation behind the tune and a smaller room. No crush — the record is polished, just grittier.",
    autotuned: true,
    retuneGlideMs: 0,
    dryWet: 1,
    drive: 5,
...
export const ARTISTS = [
  { id: "julian" as const, name: "Julian Casablancas", band: "The Strokes" },
...
/**
 * How far along the walk from NEUTRAL each family of parameters is at a given
 * match. Tuning leads and tone follows, on purpose:
 *
 * - `dryWet` reaches full wet at 60%. Below that, part of your UNTUNED voice
 *   is mixed under the tuned copy, and on speech (where corrections run to
 *   half a semitone) that is a detuned double, not a subtle blend.
 * - Glide walks GEOMETRICALLY from 250 ms to the voice's value. Perception of
 *   retune speed is logarithmic - 0 to 10 ms is a different effect, 150 to
 *   250 ms is nothing - so a linear walk spent most of the slider in the
 *   100-170 ms band, which on a spoken voice is a drunken slide between
 *   notes. That band is now passed through quickly.
 */
const wetT = (t: number) => Math.min(1, t / 0.6);
const glideT = (t: number) => Math.min(1, t / 0.85);
...
export function resolveParams(
  ...
  // Geometric walk needs a non-zero floor; a voice at exactly 0 lands there
  // once the walk completes.
  const gEnd = Math.max(voice.retuneGlideMs, 2);
  let retuneGlideMs = NEUTRAL.retuneGlideMs * Math.pow(gEnd / NEUTRAL.retuneGlideMs, glideT(t));
  if (voice.retuneGlideMs === 0 && glideT(t) >= 1) retuneGlideMs = 0;
  let dryWet = lerp(NEUTRAL.dryWet, voice.dryWet, wetT(t));
  ...
  return {
    ...
    // The SHAPE of a space is not interpolated, only its level - the same
    // rule as echo time below. A 20% blend is the record's room, quieter,
    // not a different room. Likewise the vibrato's onset is a trait of the
    // voice, not a quantity of it.
    roomSize: voice.roomSize,
    roomToneHz: voice.roomToneHz,
    warbleOnsetMs: voice.warbleOnsetMs,
