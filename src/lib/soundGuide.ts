      ...
      entries: [
        {
          ...
          tryThis: "On Demo '06, hold one long \"ahh\" and slide your voice upward, then pull glide from its 45 ms down to 0 and do it again. At 45 ms your slide survives as a quick scoop into each note; at 0 it is chopped into discrete steps. Then push it to 150 and speak a sentence: every syllable now drifts drunkenly between notes, which is why none of the album voices sit above 45. That stepped artefact was an accident of the first pitch-correction software in 1997 and a deliberate lead-vocal sound within about a year — the 1998 hit that made everyone notice it, then rap hooks, then pop choruses, then hyperpop.",
        },
        {
          term: "key / scale",
        ...
        },
        {
          ...
          tryThis: "Hi-fi '20 sits at +3, and the formant thinning that comes with it is most of why it reads as a lifted, lighter register rather than as you a third higher. Pull the shift to 0 and the character collapses back into your ordinary voice; push it to +5 and you can hear why it stops at three — past about four semitones the shifter stops reading as higher and starts reading as a smaller person. Then set −12 and speak: that is the film monster-voice trick, and also the octave-down double producers stack under a chorus to make it feel wider.",
        },
        {
      ...
      entries: [
        {
          ...
          tryThis: "Garage '01 sits at drive 8 with the low cut at 280 Hz. Drop drive to 1 and it becomes a thin, clean phone voice; walk it back up and at 4–6 you just sound urgent, while by 8 it is the small-amp shout. That is how this was got in practice long before plugins: a vocal mic into a distortion pedal, a broken preamp, or a little guitar amp in the corner — which is literally how the first Strokes record was cut.",
        },
        {
          ...
          tryThis: "Pick Machine '13 (11 bit), sing a loud note and let it fade to nothing — you can hear the fuzz walk out from under the note as you get quieter. Set bit depth to 16 and the same fade stays clean; set it to 6 and it is a handheld game chip. Twelve-bit samplers got this for free; chiptune, lo-fi hip-hop and industrial vocals then went looking for it on purpose.",
        },
        {
        ...
        },
        {
          ...
          tryThis: "Demo '06 ships at 1.1 Hz with a 7-cent swing — well under vibrato speed, which is where its hazy cassette feel comes from. Push it to 6 Hz and the same voice suddenly has a singer's vibrato; drop it to 0.6 Hz and it is a warped tape. Engineers spent decades trying to eliminate this instability from tape, and now add the slow sway and the fast tremble back in deliberately.",
        },
        {
          ...
          tryThis: "Machine '13 runs 5.5 Hz at 10 cents, a light flutter. Push the depth to 70 and it is seasick; pull it to 15 and it is a slightly nervous singer. That wide, drifting version is the damaged-tape sound vaporwave and lo-fi built an entire aesthetic out of, and it is exactly the setting the voices here stay away from.",
        },
        {
          term: "vibrato onset / bloom",
          plain: "Keeps the wobble off until a note has been held long enough to deserve it.",
          deeper: "At 0 the pitch wobble is always running, whether you are singing or talking — that is tape wow, and it does not care what you are doing. Set a time and the wobble is silent through speech and note attacks, then grows in smoothly once a single note has been held that long; change note, or stop, and it resets to nothing. That is how a singer's vibrato actually behaves: the note lands straight, the vibrato blooms a beat later, and consonants never wobble.",
          tryThis: "Pick Strings '22 and talk normally — dead steady. Now hold one vowel for two seconds and listen for the vibrato arriving around the quarter-second mark. Set the onset to 0 and say the sentence again: the same wobble is now smeared over every syllable, which is the whole difference between a crooner and a warped cassette.",
        },
      ],
    },
    {
      ...
      entries: [
        {
          ...
          tryThis: "Garage '01 has its low cut at 280 Hz. Drag it down to 80 and the same distortion suddenly sounds like a full-range vocal with a fuzz pedal on it; push it up to 520 and it is a megaphone. Nothing else moved. Almost every vocal ever released has a low cut on it around 80–100 Hz; the megaphone is just that same control taken somewhere unreasonable.",
        },
        {
        ...
        },
        {
          ...
          tryThis: "Julian Auto carries +11 dB here. Set it to 0 and the words retreat behind the distortion even though nothing got quieter; put it back and they walk to the front. Then try +18 and listen to how hard the s and t sounds get. When a vocal is buried but already loud enough, this band is the fix — more level would only make the whole mix worse.",
        },
      ],
    },
    {
      ...
      entries: [
        {
          ...
          deeper: "A copy of your voice is smeared through a recording of how a room answers a single sharp click, which produces the thousands of overlapping reflections that room would make. Reflections arriving just after the direct sound are the only cue your ears get for distance, so this control is really a depth fader, not a prettiness fader. Which space it is, and how bright, are the two controls after this one.",
          tryThis: "Posty Auto sits at 0.32. Take it to 0 and the vocal is pressed flat against your face; go to 0.45 (Lounge '18's setting) and you step back in front of a plate; go to 1.0 and you are at the back of it. Lead vocals on records are usually drier than people expect — most of the room you think you hear is on the backing vocals sitting behind the lead.",
        },
        {
          term: "room size / space",
          plain: "Slides between a tight booth and a long plate.",
          deeper: "There are two spaces under this control rather than one, and the slider crossfades between them: a small booth whose reflections are gone inside half a second, and a plate that rings on for a couple of seconds. The middle is both at once — close reflections plus a tail — which is roughly what a real room does. Two levels blend without a hitch, which is why it is built this way rather than as one room being stretched and shrunk.",
          tryThis: "Put room at 0.4 and slide size from booth to plate while speaking. At the booth end you are in a vocal booth: present, slightly boxy, no tail. At the plate end the words hang in the air after you stop. Garage '01 sits near the booth end; Lounge '18 and Stadium '19 sit at the plate end, which is most of why one is in your face and the other is across a hall.",
        },
        {
          term: "room tone / brightness",
          plain: "How bright the reflections are, without touching your voice.",
          deeper: "A filter on the reverb return alone. Dark settings make the space woolly and push it behind you — they also hide the fizz a distorted vocal throws into a reverb, which is why the crunchier voices sit low here. Bright settings let the top end of the reflections ring, which reads as a metal plate or a hard-walled hall and puts the room on an equal footing with the voice.",
          tryThis: "Set room 0.5, size at plate, and sweep the tone from 1000 Hz to 8000 Hz while talking. At 1000 you are in a carpeted basement; at 8000 you are in a tiled stairwell. Demo '06 lives at 2600 and Stadium '19 at 6500 — the same control, two decades apart.",
        },
        {
      ...
      entries: [
        {
          ...
          deeper: "This interpolates every parameter from a neutral starting point — your own voice, essentially untreated — toward the chosen voice's values, so glide, blend, drive, bit depth, both filters, presence, room and echo level all move together. It is a genuine crossfade of settings, not a preset with the volume turned down, which is why 20% really does sound like 20%. Echo time, the shape of the room and the vibrato's onset are the exceptions and stay fixed, so a low blend gives you the same echo in the same space, more quietly, rather than a different one.",
          tryThis: "Speak the same sentence on Amp '03 at each chip: 1%, 50%, 70%, 100%. Every voice comes in at 100% — picking a record gives you that record, and this is how you dial back towards yourself. Somewhere around 50–70% it stops sounding like an effect and starts sounding like a decision, which is where most records live — the treated vocal blended under the natural one so the character reads as attitude. The walk is not linear on purpose: the tuning is fully in by 60%, and the retune glide moves fast through the 100–170 ms band where a spoken voice starts sliding drunkenly between notes.",
        },
        {
